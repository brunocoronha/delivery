 ...
 */
public class TelaRegistrarPedidoUsuario extends javax.swing.JFrame {
...
//                }
    ...
    private void jButton_salvarPedidoActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton_salvarPedidoActionPerformed
        ...
        try {
            ...
            Cliente clienteSelecionado = clientes.consultar(idCliente);
            System.out.println(clienteSelecionado.toString());
            for (Entregador i : entregadorLista) {
                if (i.getNome().equals(jComboBox_Motoqueiro.getSelectedItem().toString())) {
                    entregadorSelecionado = i;
                    break;
                }
            }
            String textoObervacao = jTextArea_descricaoPedido.getText();
            Pedido pedido = new Pedido(clienteSelecionado.getId(), entregadorSelecionado.getId(), textoObervacao, StatusPedidoENUM.PEDIDO_RECEBIDO);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaRegistrarPedidoUsuario.class.getName()).log(
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaRegistrarPedidoUsuario().setVisible(true);
            }
        });
    }
