 ...
 */
public class TelaCadastroClienteUsuario extends javax.swing.JFrame {
     ...
     */
    public TelaCadastroClienteUsuario() {
        initComponents();
...
//        telaPrincipalUser.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaCadastroClienteUsuario.class.getName()).log(java.util.logging.Level.SEVERE,
                    null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaCadastroClienteUsuario().setVisible(true);
            }
        });
    }
